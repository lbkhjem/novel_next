...
const handler = async (req, res) => {
  ...
  const URL =
    `https://bestlightnovel.com/novel_list?type=latest&category=${idgenres}&state=all&page=1`;
  ...
  getPageContent(URL + page).then(($) => {
    ...
    var novels = {
      url:
      `https://bestlightnovel.com/novel_list?type=latest&category=${idgenres}&state=all&page=` +
        page,
      page: page,
      data: data,
